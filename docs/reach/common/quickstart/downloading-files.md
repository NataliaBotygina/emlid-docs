...
??? note "Reach RS2 workflow"
	...
	* **Network LED is solid blue.** Reach is in [client mode](#reach-is-in-client-mode) and connected to the Wi-Fi network.
	<br>
...
To download the system report you just need to open the *Settings tab* and go to *General settings*.

### Logs

<div style="text-align: center;"><img src="../img/quickstart/downloading-files/logging.png" style="height: 550px;"></div>

You can download logs as well as start or stop logs recording in the *Logging* in ReachView 3.

### Survey projects

<div style="text-align: center;"><img src="../img/quickstart/downloading-files/survey.png" style="height: 550px;"></div>

Survey projects contain points you saved during RTK survey. You can find them in the *Survey* tab in ReachView 3.
